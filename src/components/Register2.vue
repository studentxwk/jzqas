                ...
                <div class="form-box">
                    ...
                    <div class="step-box">
                        <ul>
                            ...
                            <li v-if="current === 1">
                                <Form ref="formValidate" :model="formValidate" :rules="ruleValidate1"
                                      :label-width="90">
                                    <Form-item label="公司名称" prop="supplierName">
                                        <Input v-model="formValidate.supplierName"></Input>
                                    </Form-item>
                                    <Form-item label="营业执照号" prop="corpRegNo">
                                        <Input v-model="formValidate.corpRegNo"></Input>
                                    </Form-item>
                                    <Form-item label="公司法人" prop="corporation">
                                        <Input v-model="formValidate.corporation" class="append-hack"></Input>
                                    </Form-item>
                                    <Form-item label="主要供应类型" prop="vendorType">
                                        <Select v-model="formValidate.vendorType">
                    ...
                    if (valid) {
                        if (this.current === 0) {
                            ...
                            if (this.current === 1) {
                                ...
                                this.ajax.post(api.register2(), regUser, (data) => {
                                    this.current = 2;
